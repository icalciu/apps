...
def usage():
  print (sys.argv[0] + " --graph <graph> --app <app> [--threads <threads>] [--verbose] [--tracker]")
  ...
  print ("tracker: simulation mode (default: no simulation)")

################### PBSIM ###############################
def do_attach_tracker():
  #attach PBSim
  if config_attach_tracker:
...
######################
config_attach_tracker = False

tracker='sudo ./tracker'

#home='/home/upifpga/ml/graphs/datasets/'
home='/home/icalciu/ml/graphs/datasets/'
...
#home_twitter='/home/upifpga/ml/graphs/datasets/Twitter-dataset/data/'
home_twitter='/home/icalciu/ml/graphs/datasets/Twitter-dataset/data/'
...
do_run_app(app, sg)
os.system("cat /proc/{0}/status".format(pid));
